	...
	return (
      ...
      <section className="flex flex-col p-4 justify-center items-center w-4/5 h-4/5 bg-gray-50 rounded shadow relative gap-10">
      	<div className="flex justify-center items-center gap-5">
      		<h1 className="w-full text-center text-zinc-800 tracking-tight font-black">Pagamento não foi efetuado com sucesso</h1>	
      		<XCircle size={32} color="#10B981" weight="bold" />
      	</div>
